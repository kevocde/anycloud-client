        ...
        <div class="container">
            <div class="main-header-left ">
                ...
                <a class="header-brand" href="index.html">
                    <img src="/valex-theme/html/assets/img/brand/logo-white.png" class="desktop-dark">
                    <img src="/valex-theme/html/assets/img/brand/logo.png" class="desktop-logo">
                    <img src="/valex-theme/html/assets/img/brand/favicon.png" class="desktop-logo-1">
                    <img src="/valex-theme/html/assets/img/brand/favicon-white.png" class="desktop-logo-dark">
                </a>
            </div><!-- search -->
            <div class="main-header-right">
                <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <div class="main-message-list chat-scroll ps">
                                <a href="#" class="p-3 d-flex border-bottom">
                                    <div class="  drop-img  cover-image  " data-image-src="/valex-theme/html/assets/img/faces/3.jpg" style="background: rgba(0, 0, 0, 0) url(&quot;</valex-theme/html/assets/img/faces/3.jpg&quot;) repeat scroll center center;">
                                ...
                                <a href="#" class="p-3 d-flex border-bottom">
                                    <div class="drop-img cover-image" data-image-src="/valex-theme/html/assets/img/faces/2.jpg" style="background: rgba(0, 0, 0, 0) url(&quot;</valex-theme/html/assets/img/faces/2.jpg&quot;) repeat scroll center center;">
                                        <span class="avatar-status bg-teal"></span>
                                    </div>
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                ...
                                <a href="#" class="p-3 d-flex border-bottom">
                                    <div class="drop-img cover-image" data-image-src="/valex-theme/html/assets/img/faces/9.jpg" style="background: rgba(0, 0, 0, 0) url(&quot;</valex-theme/html/assets/img/faces/9.jpg&quot;) repeat scroll center center;">
                                        <span class="avatar-status bg-teal"></span>
                                    </div>
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                ...
                                <a href="#" class="p-3 d-flex border-bottom">
                                    <div class="drop-img cover-image" data-image-src="/valex-theme/html/assets/img/faces/12.jpg" style="background: rgba(0, 0, 0, 0) url(&quot;</valex-theme/html/assets/img/faces/12.jpg&quot;) repeat scroll center center;">
                                        <span class="avatar-status bg-teal"></span>
                                    </div>
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                ...
                                <a href="#" class="p-3 d-flex border-bottom">
                                    <div class="drop-img cover-image" data-image-src="/valex-theme/html/assets/img/faces/5.jpg" style="background: rgba(0, 0, 0, 0) url(&quot;</valex-theme/html/assets/img/faces/5.jpg&quot;) repeat scroll center center;">
                                        <span class="avatar-status bg-teal"></span>
                                    </div>
                                    <div class="wd-90p">
                                        <div class="d-flex">
                    ...
                    <div class="dropdown main-profile-menu nav nav-item nav-link">
                        <a class="profile-user d-flex" href=""><img alt="" src="/valex-theme/html/assets/img/faces/6.jpg"></a>
                        <div class="dropdown-menu">
                            <div class="main-header-profile bg-primary p-3">
                                <div class="d-flex wd-100p">
                                    <div class="main-img-user"><img alt="" src="/valex-theme/html/assets/img/faces/6.jpg" class=""></div>
